...
Materials::Materials() {
	...
	*/
	...
	//conti_act
	vFieldContiAct[0][0] = vector3df(-0.8f, 0.1f, 0.0f);
	vFieldContiAct[0][1] = vector3df(0.0f, 0.1f, 0.0f);
	vFieldContiAct[0][2] = vector3df(-0.8f, 1.3f, 0.0f);
	vFieldContiAct[0][3] = vector3df(0.0f, 1.3f, 0.0f);
	vFieldContiAct[1][0] = vector3df(0.2f, 0.1f, 0.0f);
	vFieldContiAct[1][1] = vector3df(1.0f, 0.1f, 0.0f);
	vFieldContiAct[1][2] = vector3df(0.2f, 1.3f, 0.0f);
	vFieldContiAct[1][3] = vector3df(1.0f, 1.3f, 0.0f);
